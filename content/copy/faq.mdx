<Small>
  Last updated: <DateUpdated date={`2020-09-13`} small={`true`} />
</Small>

Hello friend 👋, thanks for check it out an interest in me and my
profile.
...
I'm _really_ enjoying using the [Jamstack] right now, with [Gatsby]
...
the used by section on their [site], it's quite popular.
...
I do appreciate the value of working closely with colleges and I am
comfortable with that too using tools like Slack, MS Teams, Zoom etc!
...
[about]: https://gergatron.com/#about
[read this first]: https://gergatron.com/faq
